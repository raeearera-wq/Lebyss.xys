...
if not LPH_OBFUSCATED then
    ...
    SWG_Dev = false
    SWG_Version = "V.25"
    SWG_Title = 'Lebyss.xys Premium 30d https://discord.gg/EDDftEDwkk'
    SWG_ShortName = 'Premium'
    SWG_FullName = 'Lebyss.xys'
    SWG_FFA = false
end;
...
do
    ...
    local magicbullet = ui.box.aimbot:AddTab("Aim")
...
do
    ...
    hbb:AddToggle('RAGE_cancollide',{Text = 'legit',Default = false,Callback = function(v)
        cancollide = z
    end})
    hbb:AddToggle('RAGE_cancollide',{Text = 'BOT',Default = false,Callback = function(v)
        cancollide = z
    end})
    ...
    hbb:AddToggle('hitbox_cancollide',{Text = 'Fov 120',Default = false,Callback = function(v)
        cancollide = v
    end})
    hbb:AddToggle('hitbox_cancollide',{Text = 'Rage',Default = false,Callback = function(v)
        cancollide = v
    end})
    hbb:AddToggle('hitbox_cancollide',{Text = 'Aimbot',Default = false,Callback = function(v)
        cancollide = v
    end})
    hbb:AddToggle('hitbox_cancollide',{Text = 'headshot',Default = false,Callback = function(v)
        cancollide = v
    end})
...
do
    ...
    espb:AddSlider('espoutlineboxtransparency',
        { Text = 'RAGE ESP', Default = 0, Min = 0, Max = 1, Rounding = 1, Compact = false }):OnChanged(function(
        State)
        es.box_outline_color[2] = State
        cheat.EspLibrary.icaca()
    end)
    espb:AddSlider('espoutlineboxtransparency',
        { Text = 'ESP BOT', Default = 0, Min = 0, Max = 1, Rounding = 1, Compact = false }):OnChanged(function(
        State)
        es.box_outline_color[2] = State
        cheat.EspLibrary.icaca()
    end)
    espb:AddSlider('espboxfilltransparency',
        { Text = 'ESP ZOMBIE', Default = 0.5, Min = 0, Max = 1, Rounding = 1, Compact = false }):OnChanged(function(
        State)
